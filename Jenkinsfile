      ...
      script {
        openshift.withCluster() {
          openshift.withProject("${devProject}") {
            ...
            openshift.selector("bc", "tasks").startBuild("--from-file=http://nexus3.${GUID}-nexus.svc.cluster.local:8081/repository/releases/org/jboss/quickstarts/eap/openshift-tasks/${version}/openshift-tasks-${version}.war"
